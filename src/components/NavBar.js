...
import { faHome, faInfoCircle, faEnvelope, faSchool, faPersonChalkboard, faTable, faMoneyCheckDollar, faExternalLink, faAddressBook } from '@fortawesome/free-solid-svg-icons';
